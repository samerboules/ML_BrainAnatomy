...
namespace MagicLeap
{
    ...
    public class PersistentBall : MonoBehaviour
    {
        ...
        {
            BrainMenuControl BrainMenuControl_ = gameObject.GetComponent<BrainMenuControl>();
            BrainMenuControl_.LerpTransitionRotation = false;
        ...
        private void HandleControllerTouchpadGestureStart(byte controllerId, MLInputControllerTouchpadGesture gesture)
        {
                ...
                && gesture.Type == MLInputControllerTouchpadGestureType.Tap)
            {
                ...
                //If highlighted and touchpad tap, switch to next part data
                BrainMenuControl BrainMenuControl_ = gameObject.GetComponent<BrainMenuControl>();
                BrainMenuControl_.NextPart();
